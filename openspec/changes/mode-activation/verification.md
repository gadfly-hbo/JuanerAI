...
- Verdict: `HOST_RUNTIME_REPLACEMENT_PASS_EXACT_CANDIDATE_VALIDATION_REQUIRED`
- Meaning: Exact Candidate `716c0ac7809f118e54c741645fd25ec4962c7c98` and its Validator `FAIL` remain rejected/superseded history. Descendant code Candidate `eb090800d85672470f6b6b950b2c99a14665e21b` contains the bounded RELEASE repair, and the authorized rollback-first Host Runtime replacement now binds the installed `coordinator.mjs` exactly to repaired SHA-256 `c04193f05a704890be51a22938123c527d0157f0f6270ad2324fc4b65415e996`. Preflight, rollback, rollback audit, clean install, and postflight all passed with an empty pointer and preserved State/Ledger/history. A final evidence-only descendant Candidate and one fresh exact-Candidate Validator are now required. No PR, archive, merge, main synchronization, RELEASE, Activation-ready claim, or product-Change authority is implied by this Gate.
...
- Descendant code Candidate: `eb090800d85672470f6b6b950b2c99a14665e21b`; tree `d04986e552ea0f27ced0a364805b9a1c8002fdc0`; parent/rejected Candidate `716c0ac7809f118e54c741645fd25ec4962c7c98`; local and remote branch Head read back equal after normal push.
- Next Gate: commit and push this Host Runtime replacement evidence as the final descendant Candidate, read back exact local/remote equality, then start exactly one fresh exact-Candidate Validator. `MA-TASK-013`, PR creation, bootstrap archive, merge, main synchronization, RELEASE, and any product Change remain locked until the applicable later Gates.
...
- Runtime binding: the rollback-first replacement completed successfully and the installed Mac mini Host Loop now contains `coordinator.mjs=c04193f05a704890be51a22938123c527d0157f0f6270ad2324fc4b65415e996`, exactly matching the repaired repository code. This closes only the stale-runtime blocker; it does not itself establish fresh Validator PASS, PR acceptance, archive, merge, main synchronization, RELEASE, Activation readiness, or product-Change authority.
- Candidate formation: commit `eb090800d85672470f6b6b950b2c99a14665e21b` contains the frozen Test, minimal Coordinator repair, historical `716c0ac` Validator FAIL, GREEN evidence, and Controller project-control records. It was pushed normally to `origin/work/macbook/mode-activation`; exact local/remote Head equality passed. No PR was created.

## Current Host Runtime Replacement PASS Evidence

- Authorization boundary: replacement used the approved rollback-first mechanism only. `install-host-loop` was not modified, no in-place overwrite was used, no historical rollback request was reused, and no product command or Change was admitted.
- Preflight: successful-install manifest SHA-256 `abdb59817d3c4fad937261d47fcecdbef65228378dd9b7b1504a72d7624d793d` and preflight receipt SHA-256 `79aab423592aae3a6a986eebdeb86b6ce35ddccce2e043cf1d05dab93b988597` were frozen with `active_change_id=null`, pointer SHA-256 `811f872ce38df88357395b2a438eb1c96504f1b583dd77724867f6dc0eaf32a9`, and exact replacement source Coordinator SHA-256 `c04193f05a704890be51a22938123c527d0157f0f6270ad2324fc4b65415e996`.
- Rollback: a new canonical rollback request, SHA-256 `5f8dd48d8a4f8ed0a1ab058576ef877ba14b383e3eaf3989b223079448ae2433`, was bound to that manifest and executed exactly once. Rollback receipt SHA-256 `5f7e72fe370d71a6fba0447e6deff9352bde5c0ae275661eb69a6e12609d1c9c` reported `rolled_back=true` and preserved active pointer, State, Ledger, Handoff, canary evidence, and Git history.
- Rollback audit: receipt SHA-256 `814239de6823b5c0fec50d179130422e0c1ff1c44e44c2a64a3bed9b6017bb33` returned `PASS`; pointer bytes remained `811f872c...`, `active_change_id=null`, service/runtime/CLI/Socket targets were restored to their recorded pre-install state, and all seven temporary traversal ACLs were removed without changing historical manifests.
- Clean install: the frozen canonical plan SHA-256 `a8b5abf1fb6675cef9e5064e36d9bb9607871f9839f8060309f02ce8f5f6ce3e` was executed once. Install receipt SHA-256 `961d7a1a12d9506e80f3a23b718489e1a5fdd9c2fbc3f1bf1bfb278c0ffbb2a4` created manifest `/private/var/db/juanerai/change-coordinator-install-backups/208b5df591a784d0c75c5e19e1ffde5a/manifest.json`, SHA-256 `c88291bc466cb970a9ed75c75bd7bb3ca2dab506f06a3bb290635c07f2ef7e36`, and service readback SHA-256 `b537206d8dca130ee9f7a58a70486ed51da35c3d65444aa95691846cf0c3e1c3`.
- Postflight: receipt SHA-256 `e8b38bac53366059e947d5b366b94d5d35c008edab5a3ce6d1db869d6216dd8e` returned `PASS`. Installed runtime equals source for `adapters.mjs=ce8da4f6c72427a45e09b503436b6368672811b9d66db9b954c132ed0acacd53`, `coordinator.mjs=c04193f05a704890be51a22938123c527d0157f0f6270ad2324fc4b65415e996`, `host-loop.mjs=8ef00f8a066142a12bd86908b51004fdb52016199334ace2d88f3671fd499c91`, and `production.mjs=4fec4c2a5ad803a607fa799ff514dbe20669a5e7dd2c4f209bc190238d098509`.
- Unchanged governed targets: CLI `f5d0d927...`, plist `addbde20...`, fixed Git `2.54.0` / `6b348e22...`, both non-system dynamic libraries, trust, host config, branch key, and PR credential all match the frozen plan/source identities. Secret bytes were neither emitted nor recorded.
- Authority readback: fixed CLI `status` exited `0` with stdout SHA-256 `de94a7b9a1585f1282a3ddf580950347c2a81eaebf854111fb2252a796c37938`, `active_change_id=null`, and `pointer_status=EMPTY`; the Socket is `root:staff 0660`; each of the seven ancestor directories has exactly `user:bendandebaba allow search` and denies runtime-user effective write; Evidence Ref remains absent because no product Change has begun.
- Disposition: `PASS` for Host Runtime replacement and source/runtime equality. This evidence supersedes only the stale-runtime statement in the prior Host Install section; historical manifests, failed attempts, rejected Candidates, and Validator findings remain immutable evidence.
