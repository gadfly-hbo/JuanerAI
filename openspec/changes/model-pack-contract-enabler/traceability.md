...
| REQ-MPC-001 | AC-MPC-001-02 | TEST-MPC-001 | TASK-003,006 | canonical synchronous serializer/admission; closed all-own-key calls including arrays; exact bounds; Proxy sanitization; detached bytes/value | VALIDATOR 005 FAIL; TEST RETURN |
| REQ-MPC-001 | AC-MPC-001-03 | TEST-MPC-001 | TASK-003,006 | exact sanitized error carrier with provenance/context ownership; synchronous contract throw; compatibility/artifact/status/permission precedence | VALIDATOR 005 FAIL; TEST RETURN |
...
| REQ-MPC-003 | AC-MPC-003-01 | TEST-MPC-005 | TASK-004,007 | exact binding/predictor factory; closed dependencies array; governed identity length/no-credential boundary; adversarial public-carrier sanitization | VALIDATOR 005 FAIL; TEST RETURN |
...
| REQ-MPC-004 | AC-MPC-004-03 | TEST-MPC-001..009 | TASK-003,004 | exact signature/error-delivery and independently named material mutation leaves | ELEVEN PRIOR LEAVES GREEN; FOUR MISSING |
...
| TASK-003 | TEST-MPC-001..004 | Validator 005 package Test return active; production frozen |
| TASK-004 | TEST-MPC-005..009 plus existing frozen TEST-XCLI-021 | Validator 005 Runtime Test return active; every other Test frozen |
| TASK-005 | all tests and exact Worker scope | reopened pending exact four-leaf causal RED |
