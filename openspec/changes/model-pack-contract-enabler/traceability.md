...
| REQ-MPC-001 | AC-MPC-001-02 | TEST-MPC-001 | TASK-003,006 | canonical synchronous serializer/admission; closed all-own-key calls including arrays; exact bounds; Proxy sanitization; detached bytes/value | CAUSAL RED PASS |
| REQ-MPC-001 | AC-MPC-001-03 | TEST-MPC-001 | TASK-003,006 | exact sanitized error carrier with provenance/context ownership; synchronous contract throw; compatibility/artifact/status/permission precedence | CAUSAL RED PASS |
...
| REQ-MPC-003 | AC-MPC-003-01 | TEST-MPC-005 | TASK-004,007 | exact binding/predictor factory; closed dependencies array; governed identity length/no-credential boundary; adversarial public-carrier sanitization | CAUSAL RED PASS |
...
| REQ-MPC-004 | AC-MPC-004-03 | TEST-MPC-001..009 | TASK-003,004 | exact signature/error-delivery and independently named material mutation leaves | FOUR NEW LEAVES FROZEN; CAUSAL RED PASS |
...
| REQ-MPC-004 | AC-MPC-004-05 | Controller TDD_READY evidence | TASK-005 | renewed two-suite hashes/counts and exact four-leaf causal RED; two production paths released | TDD_READY PASS |
| REQ-MPC-004 | AC-MPC-004-06 | Controller retirement Gate | TASK-003,004,010 | prior 11-leaf delta healthy; four material permanent leaves absent | REOPENED |
...
| TASK-004 | TEST-MPC-005..009 plus existing frozen TEST-XCLI-021 | Validator 005 Runtime Test return complete; two leaves causal RED; all other Tests frozen |
| TASK-005 | all tests and exact Worker scope | renewed TDD_READY PASS; two production paths released |
| TASK-006 | REQ-MPC-001, 002, 005 | bounded two-file Worker return complete and frozen |
| TASK-007 | REQ-MPC-003, 005 | bounded Runtime Worker complete and GREEN |
| TASK-008 | REQ-MPC-004, 005 | exact graph integration complete and frozen |
| TASK-009 | TEST-MPC-001..009 and affected baseline | historical standard GREEN; four material leaves reopen |
| TASK-010 | every changed test asset | reopened after Validator 005 |
| TASK-011 | all Requirements, ACs, tests, code, scope, evidence | Validator 001..005 FAIL historical; fresh Validator required after correction |
