...
export function parseClosedFixture(bytes) {
...
export function metricFor(rows, windowId, startDate, endDate) {
...
export function calculateFixtureOracle(rows) {
...
export function expectedConfirmedContract(run_id, confirmed_at) {
  const proposal = expectedAnalysisProposal();
  return {
